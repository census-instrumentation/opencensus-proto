...
class MetricsService(object):
    ...
    def Export(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_stream(request_iterator, target, '/opencensus.proto.agent.metrics.v1.MetricsService/Export',
            opencensus_dot_proto_dot_agent_dot_metrics_dot_v1_dot_metrics__service__pb2.ExportMetricsServiceRequest.SerializeToString,
            opencensus_dot_proto_dot_agent_dot_metrics_dot_v1_dot_metrics__service__pb2.ExportMetricsServiceResponse.FromString,
